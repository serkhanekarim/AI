...
import os
import re
from modules.preprocessing.text_normalizer import cleaners
from modules.preprocessing.text_normalizer.symbols import symbols
from modules.preprocessing.text_normalizer.symbols import _punctuation as punctuation_symbols
...
HETERONYMS = set(files_to_list(os.path.join('modules','preprocessing','text_normalizer','data','heteronyms')))
