...
#
# ./job_flowtron_training.sh /path/to/config.json /path/to/singularity_name.sif
#
# or to resume training:
#
# ./job_flowtron_training.sh /path/to/config.json /path/to/singularity_name.sif /path/to/checkpoint/model
